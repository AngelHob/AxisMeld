...
五小时最终构建尚未确定。当前映射菜单生产检查点为 `8341fdac9b0`，自动化通过、独立审查中；
...
| 长映射列表及层级操作 | 实现与自动回归完成，独立审查中 | b93e8266e77 + 871911034b1 + 8341fdac9b0；38 原生、40 Python、5 CTest；真实标准/窄窗/四视图映射与既有 GUI 回归通过 | H5-02 |

...
| 编号 | 前置条件与操作 | 预期 | 人工状态 |
|---|---|---|---|
| OM-01 | Object选中Cube，Shift+RMB唤出；与提供的Maya截图对照 | 八向热盒和下方列表同时显示；下方22个主条目按Maya顺序排列，保留分隔、Mapping/Booleans/Polygon Display三个目录；不必另进Space | 待测 |

...
更新：2026-09-14。人工测试继续暂缓。S/P/C/V/T/R 共47项保持已测试（用户确认，未逐项报告通过/失败）；原 G/K/L/M3/VR/D/O/OM 共116项仍待测。本轮追加 IC-01至IC-14 热盒与菜单统一图标14项。合计177项：已测试47项，待测130项。自动化不覆盖历史人工结果，也不将待测项自动改为通过。

## 测试准备与反馈

本轮候选路径为 `D:/source/AxisMeld-build/hotbox-icons-test-install/blender.exe`，先保存原场景，再使用临时 Cube 场景。选择 AxisMeld Maya 2026 键位。最新安装证据见 `2026-09-14-hotbox-icons-acceptance.md`，程序哈希前12位 `C2B75B7D1999`；历史批次哈希不代表当前安装。

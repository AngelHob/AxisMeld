...
更新：2026-09-14。人工测试继续暂缓。S/P/C/V/T/R 共47项保持已测试（用户确认，未逐项报告通过/失败）；原 G/K/L/M3/VR/D 共84项仍待测。本轮追加 O-01至O-16 对象与预选工具入口16项。合计147项：已测试47项，待测100项。自动化不覆盖历史人工结果，也不将待测项自动改为通过。
...
| O-15 | 单/四视图、四角、125/150/200%DPI，将Object根与Views比较并外划释放 | 第2/4行及第3行真实内缘间距对齐Views，标签完整；真实起点可取消，外延有效；对角视觉空白不擅自扩大为取消区 | 待测 |
| O-16 | 尝试N/NE/SE/S/NW占位，再测试普通RMB、QWER持键重复开盒、已有Edit根及Recent | 占位有明确缺失原因且不执行；Object NW仍Sculpt缺口；旧入口可用，单纯激活持久工具不写Recent | 待测 |

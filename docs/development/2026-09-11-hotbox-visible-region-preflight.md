...
状态更新（2026-09-14）：可见区域修复已实施，原地取消后 E 失败和像素遮挡已有旧版 RED / 新版 GREEN。
原生几何、双向显隐动画、带遮挡四视图及六组 GUI 回归通过；同 DPI 侧栏手柄拖宽保留人工待验。
详见 `docs/compatibility/2026-09-14-visible-region-m2d-acceptance.md` 和统一清单 VR 项。
以下保留与五小时批次 H5-04/H5-05 对应的原始定位证据，不能把历史构建当作新修复版本。
